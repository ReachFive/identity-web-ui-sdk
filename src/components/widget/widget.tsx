...
export const themeVariables = css`
    ...
    --warning: ${props => colorToHSL(props.theme.warningColor)};
    --warning-foreground: ${_ => colorToHSL('#ffffff')};
    --success: ${props => colorToHSL(props.theme.successColor)};
    --success-foreground: ${_ => colorToHSL('#ffffff')};
