        ...
        <div>
            ...
            {allowCreatePassword && (
                <Alternative>
                    ...
                    <Intro>
                        <Link target="new-password">
                            {i18n('accountRecovery.password.title')}
                        </Link>
                    </Intro>
                </Alternative>
            )}
...
const resolveCode = () => {
    ...
    return {
        authentication: { verificationCode, email, clientId } as Authentication,
    }
}
...
export interface AccountRecoveryWidgetProps
